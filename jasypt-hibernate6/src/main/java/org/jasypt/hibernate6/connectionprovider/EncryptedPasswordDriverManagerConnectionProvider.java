...
public final class EncryptedPasswordDriverManagerConnectionProvider 
    ...
    public void configure(final Map<String, Object> props) {
       ...
       final String encryptorRegisteredName =
           String.valueOf(props.get(ParameterNaming.ENCRYPTOR_REGISTERED_NAME));
       ...
       final String driver = String.valueOf(props.get(AvailableSettings.DRIVER));
       final String url = String.valueOf(props.get(AvailableSettings.URL));
       final String user = String.valueOf(props.get(AvailableSettings.USER));
       final String password = String.valueOf(props.get(AvailableSettings.PASS));
