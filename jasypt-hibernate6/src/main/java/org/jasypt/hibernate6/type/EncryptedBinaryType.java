...
import org.jasypt.hibernate6.encryptor.HibernatePBEByteEncryptor;
import org.jasypt.hibernate6.encryptor.HibernatePBEEncryptorRegistry;

/**
 * A <b>Hibernate</b> <tt>UserType</tt> implementation which allows transparent encryption of byte[]
 * values during persistence of entities.
 *
 ...
 * </pre>
 *
 * <p>...where a <tt>HibernatePBEByteEncryptor</tt> object should have been previously registered to
 * be used from Hibernate with name <tt>myHibernateByteEncryptor</tt> (see {@link
 * HibernatePBEByteEncryptor} and {@link HibernatePBEEncryptorRegistry}).
 *
  ...
  private synchronized void checkInitialization() {
    ...
    if (!this.initialized) {
      ...
      if (this.useEncryptorName) {
        ...
        final PBEByteEncryptor pbeEncryptor = registry.getPBEByteEncryptor(this.encryptorName);
