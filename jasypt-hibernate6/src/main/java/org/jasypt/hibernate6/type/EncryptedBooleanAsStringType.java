...
/**
 * A <b>Hibernate</b> <tt>UserType</tt> implementation which allows encryption of Boolean values
...
public final class EncryptedBooleanAsStringType extends AbstractEncryptedAsStringType {
  ...
  public Object convertToObject(final String string) {
  ...
  public Object nullSafeGet(
      ...
      Object o)
      throws SQLException {
    return Objects.nonNull(resultSet.getString(i)) ? convertToObject(resultSet.getString(i)) : null;
  }
}
