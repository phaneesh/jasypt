...
/**
 * A <b>Hibernate</b> <tt>UserType</tt> implementation which allows encryption of Calendar values
 * into String (VARCHAR) database fields during persistence of entities.
 *
 ...
 *
 * <p>The boolean <tt>storeTimeZone</tt> parameter allows the Calendar to be re-created with the
 * same TimeZone that it was created. This is an <b>optional</b> parameter, and its default value is
 * <b>FALSE</b>.
 *
