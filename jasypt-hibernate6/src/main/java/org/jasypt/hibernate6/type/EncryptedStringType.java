...
/**
 * A <b>Hibernate</b> <tt>UserType</tt> implementation which allows transparent encryption of String
...
public final class EncryptedStringType extends AbstractEncryptedAsStringType {
  ...
  public Object nullSafeGet(ResultSet resultSet, int i,
      ...
      throws SQLException {
    return Objects.nonNull(resultSet.getString(i)) ? resultSet.getString(i) : null;
  }
}
